    ...
    <div className=" container mx-auto h-screen">
      ...
      <div className="h-2/3 md:w-2/4 p-3 rounded-lg mx-auto overflow-auto">
        ...
        <form onSubmit ={
          e => addCourse(e)}>
            <td>
        <select className = "bg-blue-100 rounded-2xl p-1  hover:bg-red-200" onChange = { e => 
          ...
          <td>
          <input className = "bg-blue-100 rounded-2xl p-1  hover:bg-red-200" type="text" onChange = { e => 
